  ...
  const addToCart = () => {
    ...
    if (isLocalStorageAvailable) {
      ...
      const payload = {
        ...products,
        productQuantity,
        totalPrice: products.ProductPrice * productQuantity,
      };
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        console.log(fetchedProducts?.ProductImages);
      })
      .catch((error) => {
        ...
        <div className="row">
          <div className="col-md-6">
            {products?.ProductImages?.length > 0 &&
              <ImageSection images={products.ProductImages
              } />}
          ...
          <div className="col-md-6">
            <div className="container">
              ...
              <div>
                ...
                <button className="my-3 btn btn-primary" onClick={submitReview}>
                  Submit review
                </button>
              </div>
            </div>
